...
export const graphiteDark = EditorView.theme(
  {
    ...
    '.cm-scroller': {
      ...
      fontSize: 'calc(15.5px * var(--editor-scale, 1))',
      lineHeight: 'calc(26px * var(--editor-scale, 1))',
    ...
    '.cm-gr-h1': {
      fontSize: 'calc(28px * var(--editor-scale, 1))',
      lineHeight: 'calc(34px * var(--editor-scale, 1))',
      fontWeight: '650',
    ...
    '.cm-gr-h2': {
      fontSize: 'calc(22px * var(--editor-scale, 1))',
      lineHeight: 'calc(30px * var(--editor-scale, 1))',
      fontWeight: '600',
      letterSpacing: '-0.01em',
      color: 'var(--text-0)',
      paddingTop: '8px',
    ...
    '.cm-gr-h3': {
      fontSize: 'calc(18px * var(--editor-scale, 1))',
      lineHeight: 'calc(26px * var(--editor-scale, 1))',
      fontWeight: '600',
      color: 'var(--text-0)',
      paddingTop: '6px',
    ...
    '.cm-gr-h4': {
      fontSize: 'calc(16px * var(--editor-scale, 1))',
      lineHeight: 'calc(26px * var(--editor-scale, 1))',
      fontWeight: '600',
      color: 'var(--text-1)',
    },
